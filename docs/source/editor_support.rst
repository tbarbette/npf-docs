...
NPF support in editors and IDEs is currently WIP. Support for syntax highlighting is available through a `Tree-sitter <https://tree-sitter.github.io/tree-sitter/>`_ parser, available `on the tree-sitter-npf repository <https://github.com/ntyunyayev/tree-sitter-npf>`_.
...
For `Helix <https://github.com/helix-editor/helix>`_ users, a small config is also available `on the helix-npf repo <https://github.com/ntyunyayev/helix-npf>`_. You can copy the content inside **~/.config/helix**.

Zed
--------

If you come from VSCode, this option will be the most familiar for your. An extension is available `on the zed-npf repo <https://github.com/ntyunyayev/zed-npf>`_. You can simply clone the repo and then open Zed, open the extensions menu (CTRL+SHIFT+X) click on **Install Dev Extension** and search for the cloned repo.
